...
The exported `editor_brief.md` is the human review surface. The JSON files and `chart_signal.svg` are intended for later Remotion, captioning, and publishing workers.
